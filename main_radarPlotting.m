...
marker = ["o","s","d","<",">"];
dispVar = ["U","V","W","A"];
meandir = 'G:\.shortcut-targets-by-id\1q0GnsopWaOlD6IuVOS-ZxeBIZwUFuQ-w\Stereo-DIC\Working\Data for Jeff\stepsdMeanData6a.mat';
outputfile = 'G:\.shortcut-targets-by-id\1q0GnsopWaOlD6IuVOS-ZxeBIZwUFuQ-w\Stereo-DIC\Working\Data for Jeff\Statistics Radar4';
venNum = [4,5,6,7];
load(meandir)
...
data = spiderPlotRanges(meanPerFrame,vend,steps,absType,actualDisp);
