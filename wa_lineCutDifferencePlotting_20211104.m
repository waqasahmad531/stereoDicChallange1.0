...
vend = {sandia,lava,grewer,matchID};
linclr = [0 0.4470 0.7410;0.8500 0.3250 0.0980;0.9290 0.6940 0.1250;0.4660 0.6740 0.1880];
linPro = ["-.","-.","-.","-."];
linThi = [2.5,1.65,1.25,1];
venc = 0;
% dispFields = cell(2,3);
...
box on; grid on
 ylim([-200 200])
set(gcf,'color','w')
lgd = legend('Group: 1','Group: 2', 'Group: 3','Group: 2(2)');
...
fieldP = "D:\DIC\lineCutSys1df.pdf";
