function  [plotName,caxisLim,meanVal,stat] = post_plot_v5_After20210331Meeting(regData,Z,meanVal,rmNaNFlag,iGroupNum,...
...
imgfolder = 'Plots';
imgfolder1 = fullfile(testfolder,strcat(imgfolder,'(',date,')'),'miniAOI_fixedMean','turbo');
