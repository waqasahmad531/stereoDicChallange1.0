function  [plotName,caxisLim,meanVal,stat] = post_plot_A220209Mv2(regData,Z,meanVal,rmNaNFlag,iGroupNum,...
...
imgfolder = 'Plots';
imgfolder1 = fullfile(testfolder,strcat(imgfolder,'(',date,')'),'miniAOI(view2)v2');
