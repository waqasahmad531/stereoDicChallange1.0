...
%                     meanData'
            ...
            %Plotting 
                ...
                lgd.FontSize = 13;
                lgd.Box = 'on';
                meanPlot = sprintf('meanSys%gDataset%g_%s_n2.%s',iSys,iDataset,dispVar(disp),fileFor); 
                ...
                lgd.FontSize = 13;
                lgd.Box = 'on';
                stdPlot = sprintf('stdSys%gDataset%g_%s_n2.%s',iSys,iDataset,dispVar(disp),fileFor);
