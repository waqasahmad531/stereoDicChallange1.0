...
numStdDev = 3;
fSaveRegData = false;%true %save the registered data

fSaveRegGrid_w = true; %W: I added these to avoid saving files 

fSaveRegGrid = false;%true  %create and save a regular grid of registered data
fSaveTPlotGrid = false;  %save a regular grid of data for techplot
fCalcProfileNoise = true; %calculate the noise in the profile from the 5 samples
