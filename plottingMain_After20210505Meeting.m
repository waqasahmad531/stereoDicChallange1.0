...
%%
figure(2)
plot(xVal,ZZ(xLen(xVal==lincutLoc),:),'g','LineWidth',2.5);
figure(3)
plot(xVal,ZZ(xLen(xVal==lincutLoc),:),'g','LineWidth',2.5);
%%
grewer = [310,311,312;...
...
sandia = [115;...
            125]; % Sandia 
dantec = [410 411 412;...
               420 421 422]; %group 3 system1 and 2 Dantec
lavision = [510,511,512;...
               520,521,522]; % LaVision

vend = {sandia,lava,grewer,dantec,lavision};
linclr = [0 0.4470 0.7410;0.8500 0.3250 0.0980;0.9290 0.6940 0.1250];
linPro = ["-.","-.","-."];
linThi = linspace(2.5,1,length(vend));%[2.5,1.5,1];
venc = 0;
% dispFields = cell(2,3);
...
fieldP = "G:\.shortcut-targets-by-id\1q0GnsopWaOlD6IuVOS-ZxeBIZwUFuQ-w\Stereo-DIC\Papers and Presentations\iDICs Report\IDICS StereoDIC Challenge\method\lineCutSys1.eps";
...
fieldP = "G:\.shortcut-targets-by-id\1q0GnsopWaOlD6IuVOS-ZxeBIZwUFuQ-w\Stereo-DIC\Papers and Presentations\iDICs Report\IDICS StereoDIC Challenge\method\lineCutSys2.eps";
exportgraphics(gcf,fieldP,'Resolution',600) %U Disp
