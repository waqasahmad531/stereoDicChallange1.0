function  [plotName,caxisLim,meanVal,stat] = post_plot_A210331M_withoutEdits(regData,Z,meanVal,rmNaNFlag,iGroupNum,...
                                        labn,n,testfolder,avgFlag,...
                                        storeLim,fileext,stU,stV,stW,lims,fixedmean,pltflag)
...
%Position = 0.24296875,0.569444444444444,0.209895833333333,0.194907407407408
% InnerPosition = 0.24296875,0.569444444444444,0.209895833333333,0.194907407407408
...
imgfolder = 'Plots';
imgfolder1 = fullfile(testfolder,strcat(imgfolder,'(',date,')'),'miniAOI');
...
%         title(figtit,labn,'Interpreter','latex')
    ...
    %% InnerPosition = 217.4,436.2,378.8000000000001,126.4
    % OuterPosition = 211,429.8,391.6,207.9999999999999
    % Position  = 217.4,436.2,378.8000000000001,126.4
% if pltflag    
...
%     'bottom', 'HorizontalAlignment','center', 'FontSize',8.5,...
%     'Interpreter','latex');
