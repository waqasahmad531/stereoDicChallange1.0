function  plotName = initPlot(regData,rmNaNFlag,labn,n,testfolder,avgFlag,...
                        scale,fieldName,fileext)
...
%         st = st((find(~isspace(st))));
    ...
    if fieldName == 1
        title('U [mm]','Interpreter','latex')
    elseif fieldName==2
        title('V [mm]','Interpreter','latex')
    elseif fieldName == 3
        title('W [mm]','Interpreter','latex')
    elseif fieldName == 4
        title('Abs. [mm]','Interpreter','latex')
    end
