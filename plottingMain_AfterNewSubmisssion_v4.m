...
%%
figure(2)
%plot(xVal,ZZ(xLen(xVal==lincutLoc),:),'r','LineWidth',3);
figure(3)
%plot(xVal,ZZ(xLen(xVal==lincutLoc),:),'r','LineWidth',3);
%%
% grewer = [314;
...
%                 appliedStep = strrep(appliedStep,'=>',' : ');
                ...
                if ~(ven == 3 && grp == 2)
                    if grp == 1
                        figure(2)
                        hold on 
                        %plot(xVal,Z(xLen(xVal==lincutLoc),:),linPro(venc),'Color',linclr(venc,:),'LineWidth',linThi(venc));
                       
                        plot(xVal,(ZZ(xLen(xVal==lincutLoc),:)-Z(xLen(xVal==lincutLoc),:))*1e3,linPro(venc),'Color',linclr(venc,:),'LineWidth',linThi(venc));
                        %ylim([-0.2 7])
%                         axis equal
...
box on; grid on
 ylim([-200 200])
set(gcf,'color','w')
lgd = legend('Group: 1','Group: 2', 'Group: 3');
lgd.Interpreter = 'latex';
lgd.Location = 'northwest';
xlabel('Y-axis','Interpreter','latex','FontSize',12)
ylabel('Features difference($\mu$m)','Interpreter','latex','FontSize',12)
title('Difference b/w laser scan and DIC for system 1','Interpreter','latex','FontSize',14)
fieldP = "G:\.shortcut-targets-by-id\1q0GnsopWaOlD6IuVOS-ZxeBIZwUFuQ-w\Stereo-DIC\Papers and Presentations\iDICs Report\IDICS StereoDIC Challenge\method\lineCutSys1df.eps";
...
box on; grid on
set(gcf,'color','w')
lgd = legend('Group: 1','Group: 2');
lgd.Interpreter = 'latex';
lgd.Location = 'northwest';
xlabel('Y-axis','Interpreter','latex','FontSize',12)
ylabel('Features difference($\mu$m)','Interpreter','latex','FontSize',12)
title('Difference b/w laser scan and DIC for system 2','Interpreter','latex','FontSize',14)
fieldP = "G:\.shortcut-targets-by-id\1q0GnsopWaOlD6IuVOS-ZxeBIZwUFuQ-w\Stereo-DIC\Papers and Presentations\iDICs Report\IDICS StereoDIC Challenge\method\lineCutSys2df.eps";
exportgraphics(gcf,fieldP,'Resolution',600) %U Disp
